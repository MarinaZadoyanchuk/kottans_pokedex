...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(160);
	var Pokedex = __webpack_require__(167);
	var PokemonFull = __webpack_require__(170);
	...
	var Root = React.createClass({
	  ...
	  loadMore: function () {
	    ...
	    this.serverRequest = $.get("http://pokeapi.co/api/v1/pokemon/", { limit: 12, offset: this.state.pokemons.length }, result => {
	      this.setState({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'h1',
	        { className: 'text-center', onClick: this.state.chosenType ? this.resetFilter : false },
	        React.createElement(
	          'span',
	          null,
	          'Pokedex'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(160);
	var PokemonSmall = __webpack_require__(168);
	...
	var Pokedex = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (!pokemons.length) return React.createElement(Loader, null);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'ul',
	        { className: 'list-inline list_pokemons' },
	        pokemons.map(pokemon => React.createElement(PokemonSmall, {
	      ...
	      this.props.isLoading ? React.createElement(
	        'div',
	        { className: 'is_loading text-center' },
	        React.createElement('img', { src: 'src/images/moreLoader.gif' })
	      ) : null,
	      !this.props.chosenType ? React.createElement(
	        'button',
	        { type: 'button', className: 'btn btn-primary btn-lg btn-block', onClick: this.props.onLoadClick },
	        'Load More'
	      ) : React.createElement(
	        'button',
	        { type: 'button', className: 'btn btn-default btn-lg', onClick: this.props.resetFilter },
	        'Back to list pokemons'
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PokemonSmall = React.createClass({
	  displayName: "PokemonSmall",

	  render: function () {
	    return React.createElement(
	      "li",
	      { onClick: this.props.onClick },
	      React.createElement("img", { src: "http://pokeapi.co/media/img/" + this.props.pkdx_id + ".png", className: "img-rounded img-responsive center-block" }),
	      React.createElement(
	        "div",
	        { className: "info_pokemon" },
	        React.createElement(
	          "h4",
	          ...
	          this.props.types.map(type => {
	            ...
	            return React.createElement(
	              "span",
	              {
	                ...
	                key: type.name,
	                onClick: event => {
	                  event.stopPropagation();this.props.onType(type.name);
	                }
	              },
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(160);

	var PokemonFull = React.createClass({
	  displayName: 'PokemonFull',
